...
public interface IAdventDayHub
{
    ...
    /// <param name="dayNumber">The day number of the Advent Day.</param>
    /// <param name="input">The input that was added.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    Task DayInputAdded(Guid adventDayId, int dayNumber, string input);
