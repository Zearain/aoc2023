// <copyright file="SolveDay7Part1Command.cs" company="Zearain">
...
[AdventDayPart(7, 1)]
public record SolveDay7Part1Command(int PartNumber, DayInput Input) : AdventDayPartSolutionRequest(PartNumber, Input);