// <copyright file="SolveDay8Part2Command.cs" company="Zearain">
...
[AdventDayPart(8, 2)]
public record SolveDay8Part2Command(int PartNumber, DayInput Input) : AdventDayPartSolutionRequest(PartNumber, Input);