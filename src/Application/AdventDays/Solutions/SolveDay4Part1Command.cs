// <copyright file="SolveDay4Part1Command.cs" company="Zearain">
...
[AdventDayPart(4, 1)]
public record SolveDay4Part1Command(int PartNumber, DayInput Input) : AdventDayPartSolutionRequest(PartNumber, Input);