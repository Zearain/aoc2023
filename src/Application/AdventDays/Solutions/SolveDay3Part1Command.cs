// <copyright file="SolveDay3Part1Command.cs" company="Zearain">
...
[AdventDayPart(3, 1)]
public record SolveDay3Part1Command(int PartNumber, DayInput Input) : AdventDayPartSolutionRequest(PartNumber, Input);