// <copyright file="SolveDay6Part1Command.cs" company="Zearain">
...
[AdventDayPart(6, 1)]
public record SolveDay6Part1Command(int PartNumber, DayInput Input) : AdventDayPartSolutionRequest(PartNumber, Input);